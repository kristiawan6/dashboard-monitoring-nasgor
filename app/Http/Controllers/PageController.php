...
class PageController extends Controller
{
     ...
     */
    public function loadPage($layout = 'side-menu', $pageName = 'dashboard', $data = '')
    {
    ...
    public function updateStock(Request $request, $id)
    {
        ...
        if (!$produk) {
            return redirect()->route('order')->with('error', 'Produk tidak ditemukan.');
        }
        ...
        return redirect()->route('page', ['layout' => 'side-menu', 'pageName' => 'stock-tools'])->with('success', 'Stok produk berhasil diperbarui.');
    }
}
