...
class Faker
{
    ...
    {
        $foods = collect([
            ['name' => 'Pisang Nugget Matcha', 'image' => 'pismat.png'],
            ['name' => 'Pisang Nugget Coklat', 'image' => 'piscok.png'],
            ['name' => 'Pisang Nugget Coklat Keju', 'image' => 'logoguyub.png'],
            ['name' => 'Nasi Ayam Sambal Ijo', 'image' => 'sambalijo.png'],
            ['name' => 'Nasi Ayam Sambal Matah', 'image' => 'matah.png'],
            ['name' => 'Nasi Ayam Sambal Bawang', 'image' => 'bawang.png']
        ]);
