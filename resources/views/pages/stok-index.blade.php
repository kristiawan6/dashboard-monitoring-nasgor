                        ...
                        <tr class="intro-x">
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Laravel Admin Dashboard Starter Kit" class="tooltip rounded-full"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center text-theme-11" href="javascript:;" data-toggle="modal"
                                        data-target="#edit-confirmation-modal{{ $item->id }}">
    ...
    @foreach ($data as $item)
        <div class="modal" id="edit-confirmation-modal{{ $item->id }}">
            <div class="modal__content">
                <form action="{{ route('update-stock', $item->id) }}" method="POST">
                    @csrf
                    <div class="p-5 text-center">
                        <div class="flex mt-2 flex-1">
                            ...
                            <input type="text" name="stok" class="input w-full border text-center"
